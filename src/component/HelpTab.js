...
const HelpTab = () => {
  return (
    <section className='about-tab'>
            ...
            <HelpCard src={'https://www.svgrepo.com/show/121835/low-price.svg'} title={'Low Trade Fees'} body={`At TritonsPrime, we understand the importance of cost efficiency when it comes to buying and selling NFTs. That's why we pride ourselves on offering low gas fees, ensuring that you can transact on our platform without breaking the bank. `} />    
