...
const HelpTab = () => {
  return (
    <section className='about-tab'>
            <HelpCard src={'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/MetaMask_Fox.svg/1200px-MetaMask_Fox.svg.png'} title={'MetaMask Secure Integration'} body={'This feature allows you to securely connect your Meta Mask, enabling you to interact with blockchain networks and perform transactions Seamlessly.'}/>
            ...
            <HelpCard src={'https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.svgrepo.com%2Fsvg%2F121835%2Flow-price&psig=AOvVaw1OLoUaTDKhzTzl8QBTiWmR&ust=1699778343586000&source=images&cd=vfe&opi=89978449&ved=0CBAQjRxqFwoTCOCuifjFu4IDFQAAAAAdAAAAABAD'} title={'Low Trade Fees'} body={`At TritonsPrime, we understand the importance of cost efficiency when it comes to buying and selling NFTs. That's why we pride ourselves on offering low gas fees, ensuring that you can transact on our platform without breaking the bank. `} />    
